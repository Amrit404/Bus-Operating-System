...
public interface BusOperatorRepository extends JpaRepository<BusOperator, String> {
    ...
    List<BusOperator> searhByCitiesAndDate(@Param("departureCity") String departureCity, @Param("arrivalCity") String arrivalCity, @Param("departureDate") Date departureDate);
